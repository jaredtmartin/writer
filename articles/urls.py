...
urlpatterns = patterns('',
    ...
    url(r'^project/(?P<pk>\d+)/delete/$',       DeleteProject.as_view(),        name='project_delete'),
    url(r'^project/add/$',                      CreateProject.as_view(),        name='new_project'),
    url(r'^project/(?P<pk>\d+)/detail/$',       ShowProject.as_view(),        name='project_detail'),
    
    
    url(r'^category/add/$',                     CreateCategory.as_view(),        name='new_category'),
    ...
    url(r'^articles/make-available-to-all-my-writers/$',  MakeAvailableToAllMyWriters.as_view(), name='make_available_to_all_my_writers'),
    url(r'^articles/make-available-to-writer-group/$',  MakeAvailableToWriterGroup.as_view(), name='make_available_to_writer_group'),
    ...
    url(r'^articles/make-available-to-reviewer-group/$',  MakeAvailableToReviewerGroup.as_view(), name='make_available_to_reviewer_group'),
    url(r'^articles/make-available-to-all-reviewers/$',  MakeAvailableToAllReviewers.as_view(),      name='make_available_to_all_reviewers'),
    url(r'^articles/make-available-to-all-my-reviewers/$',  MakeAvailableToAllMyReviewers.as_view(), name='make_available_to_all_my_reviewers'),
    ...
    url(r'^user/mode/$',                        ChangeMode.as_view(),       name='change_user_mode'),
    ...
    url(r'^my-writers/$',                           ListMyWriters.as_view(), name = "my writers"),
    url(r'^available-writers/$',                    ListAvailableWriters.as_view(), name = "writers avail."),
    url(r'^writers-pending/$',                      ListPendingWriters.as_view(), name = "writers pending"),
    url(r'^my-reviewers/$',                         ListMyReviewers.as_view(), name = "my reviewers"),
    url(r'^available-reviewers/$',                  ListAvailableReviewers.as_view(), name = "reviewers avail."),
    url(r'^reviewers-pending/$',                    ListPendingReviewers.as_view(), name = "reviewers pending"),
    url(r'^my-requesters/$',                        ListMyRequesters.as_view(), name = "my requesters"),
    url(r'^available-requesters/$',                 ListAvailableRequesters.as_view(), name = "requesters avail."),
    url(r'^requesters-pending/$',                   ListPendingRequesters.as_view(), name = "pending requesters"),

    url(r'^contact/writer/create/$',                CreateWriter.as_view(),    name='create_writer'),
    url(r'^contact/reviewer/create/$',              CreateReviewer.as_view(),    name='create_reviewer'),
    ...
    url(r'^groups/writers/$',                       ListWriterGroups.as_view(), name='writer groups'),
    url(r'^groups/reviewers/$',                     ListReviewerGroups.as_view(), name='reviewer groups'),
    ...
    url(r'^group/(?P<pk>\d+)/detail/$',             ShowGroup.as_view(), name='group_detail'),
