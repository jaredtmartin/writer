...
from knowledge.managers import ArticleManager, ResponseManager
...
class KnowledgeBase(models.Model):
    is_question, is_article = False, False
...
class Article(KnowledgeBase):
    ...
    status = models.CharField(verbose_name=_('Status'), max_length=32, choices=STATUSES, default='public', db_index=True)
...
class Question(Article, MessageBase):
    is_question = True
