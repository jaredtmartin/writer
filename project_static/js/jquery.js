...
<html class="js"><head>
	...
	<script src="jquery_files/ga.js" async="" type="text/javascript"></script></head>
	<body class="jq-enhanced">
	<div id="jq-siteContain">
			<div id="jq-header">
				<a id="jq-siteLogo" href="http://jquery.com/" title="jQuery Home"><img src="jquery_files/logo_jquery_215x53.gif" alt="jQuery: Write Less, Do More." height="53" width="215"></a>
...
<div id="jq-intro">
	...
	<ul>
		<li>
			<div><a href="https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js">Google Ajax Libraries API CDN</a></div>
		...
		<li>
			<div><a href="http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.2.min.js">Microsoft CDN</a></div>
			<span>Supports SSL via HTTPS (<a href="http://www.asp.net/ajaxlibrary/cdn.ashx">Documentation</a>)</span>
		</li>
		<li>
			<div><a href="http://code.jquery.com/jquery-1.8.2.min.js">jQuery CDN Minified</a> or <a style="background: none repeat scroll 0% 0% transparent; padding-left: 0pt;" href="http://code.jquery.com/jquery-1.8.2.js">Full</a></div>
			<span>via <a href="http://mediatemple.net/">Media Temple</a></span>
		</li>
		<li class="disclaim">We do not control the Microsoft or Google CDNs 
and there may be a delay from the time of a new release until it is 
available there.</li>
	</ul>
</div>
<div id="jq-download">
	...
	<form action="/" method="get">
		<fieldset>
			...
			<div id="jq-compression" class="jq-clearfix">
				<input name="name" value="http://code.jquery.com/jquery-1.8.2.min.js" id="jq-production" checked="checked" type="radio">
				...
				<input name="name" value="http://code.jquery.com/jquery-1.8.2.js" id="jq-development" type="radio">
...
<div id="jq-primaryContent" style="width:auto">
	...
	<p>The code itself is written rather cleanly in an attempt to 
self-document. If you've spotted some areas of code that could be 
improved, please feel free to discuss it on the <a href="https://forum.jquery.com/developing-jquery-core">Developing jQuery Core Forum</a>. All input is gladly appreciated!</p>
	...
	<p>When reporting issues with jQuery Git builds of jQuery, please make 
sure you include the date and time the snapshot was generated (it is 
listed at the top of the file).</p>
	<p>Linking to jQuery Git builds directly from the CDN is not advised, 
as the file is constantly refreshed and may change from minute to minute
 as new commits are made to the repository.</p>
	<p><strong>WARNING:</strong> Do NOT use the jQuery Git build in a 
production system or live application! It is not tested. It is not 
stable. It will probably blow up on you unexpectedly. You have been 
warned! If in doubt, stop and use the current release.</p>
	<p>jQuery Git <a href="http://code.jquery.com/jquery-git.js">Uncompressed</a></p>
	<h3>Build from Git</h3>
	<p><strong>Note:</strong> The following is quite advanced. If you wish 
to just use a work-in-progress version of jQuery, please try the jQuery 
Git build instead.</p>
	<p>All source code is kept under Git revision control, which you can 
browse online. There's a download link available for any file or 
directory, if you only want to download a portion of the jQuery code.</p>
	...
	<p>The repository's <a href="https://github.com/jquery/jquery/blob/master/README.md">README</a>
 has more information on building and testing your own jQuery, as well 
as links to core style guidelines and tips for patching bugs.</p>
</div></div><!-- /#content -->
					<div id="comments">
